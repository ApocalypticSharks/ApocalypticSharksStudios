...
public class PrometeoEditor : Editor{
  ...
  private SerializedProperty carTireClips;
  //
  //
  ...
  private void OnEnable(){
    ...
    game = SO.FindProperty("game");
    carTireClips = SO.FindProperty("carTireClips");
  ...
  public override void OnInspectorGUI(){
    ...
    GUILayout.Space(10);
        EditorGUILayout.PropertyField(game, new GUIContent("Game context: "));
        EditorGUILayout.PropertyField(tireScreechSound, new GUIContent("Tire Screech Sound: "));
        EditorGUILayout.PropertyField(carTireClips, new GUIContent("Tire Screech Clip: "));
